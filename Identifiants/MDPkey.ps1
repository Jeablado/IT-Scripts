...
#  
#            IL EST POSSIBLE DE FAIRE UNE AUTHENTIFICATION EN DONNANT SON MOT DE PASSE A CHAQUE EXECUTION
Read-Host -Prompt “Entrer votre mot de passe Office365” -AsSecureString | ConvertFrom-SecureString | Out-File .\TENANTNAME.key
Read-Host -Prompt “Entrer TOKEN USER GLPI” -AsSecureString | ConvertFrom-SecureString | Out-File .\USERTOKEN.key
